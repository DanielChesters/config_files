...
vim.keymap.set('', '<C-X>', ':NvimTreeToggle<CR>', { noremap = true, silent = true})
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'lua', 'typescript', 'rust', 'go', 'python', 'java', 'kotlin', 'toml', 'yaml' },
...
local servers = { 'clangd', 'rust_analyzer', 'pyright', 'tsserver', 'sumneko_lua', 'kotlin_language_server', 'jdtls',
  'taplo', 'marksman', 'grammarly', 'groovyls' }
